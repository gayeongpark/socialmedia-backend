...
router.post('/signup', (req, res, next) => {
  ...
  if (
    ...
    res
      .status(400)
      .json({ message: 'Provide username, password, firstname and lastname' });
    return;
  }
  ...
  User.findOne({ username })
    ...
    .then((createdUser) => {
      ...
      const { username, firstname, lastname, _id } = createdUser;

      // Create a new object that doesn't expose the password
      const user = { username, firstname, lastname, _id };
